...
const products = {
	...
	'product43': {
        ...
        title: 'Spider Web Button (STL Files)',
        description: 'Download and print your own Spider Web Button with this high-quality STL file from HearthForge.This gothic spider web button is ideal for cosplay costumes, Halloween outfits, craft projects, and custom clothing.The file is optimized for clean printing and works on most FDM 3D printers. Print in your own colors to match your project.Perfect for makers, crafters, and costume designers who want a unique button you won’t find in stores.',
        //price: 'Free',
        features: [
            'Easy to 3D Print, No Supports Needed',
			'Beginner-friendly 3D print',		
	...
	'product44': {
        ...
        title: 'Skull Button (STL Files)',
        description: 'Add a bold edge to your projects with this 3D printable skull button STL. Designed with a clean, stylized skull shape, this button is perfect for jackets, bags, costumes, and DIY fashion.This digital download includes a ready-to-print STL file optimized for smooth printing and durability. The design features well-defined eye sockets and a strong loop hole for secure attachment.Ideal for fans of goth, punk, and alternative styles, as well as makers looking for unique 3D printed accessories.',
        //price: 'Free',
        features: [
            'Easy to 3D Print, No Supports Needed',
			'Beginner-friendly 3D print',		
